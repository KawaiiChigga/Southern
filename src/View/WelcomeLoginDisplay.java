...
public class WelcomeLoginDisplay extends JPanel implements ActionListener, KeyListener, MouseListener {
	...
	private void initWelcomeLoginDisplay() {
		...
		btnC.setBounds(730, 530, 310, 148);
	...
	public void mouseEntered(MouseEvent e) {
		if (e.getSource().equals(btn)) {
			btn.setIcon(new ImageIcon(resizeImage("img/go.png", 310, 148)));
		}
		if (e.getSource().equals(btnC)) {
			btnC.setIcon(new ImageIcon(resizeImage("img/goC.png", 310, 148)));
		}
	...
	public void mouseExited(MouseEvent e) {
		...
		if (e.getSource().equals(btn)) {
			btn.setIcon(new ImageIcon(resizeImage("img/go.png", 300, 138)));
		}
		if (e.getSource().equals(btnC)) {
			btnC.setIcon(new ImageIcon(resizeImage("img/goC.png", 300, 138)));
		}
	}
